// ============================================================
// repositories/파일저장소.js — 07단원의 파일 저장소를 그대로 가져온 것
// ------------------------------------------------------------
// 백엔드 07단원의 repositories/안전한설비저장소.js 입니다.
// 이름만 바꿨고 내용은 손대지 않았습니다.
//
// 왜 여기 있나: 개념01 에서 SQL 저장소와 나란히 놓고 시험해 보려고요.
// 두 저장소가 **똑같이 동작한다**는 것을 눈으로 확인하는 데 씁니다.
// 서버는 이 파일을 쓰지 않습니다.
//
// 원본에 들어 있던 두 가지 장치는 그대로입니다.
//
//   ① 쓰는 작업을 줄 세운다        → 동시에 써도 안 사라짐
//   ② 임시 파일에 쓰고 이름을 바꾼다 → 쓰다가 죽어도 안 깨짐
//
// SQL 저장소에는 이 두 장치가 **없습니다.** SQLite 가 대신 해 주기 때문입니다.
// ============================================================
