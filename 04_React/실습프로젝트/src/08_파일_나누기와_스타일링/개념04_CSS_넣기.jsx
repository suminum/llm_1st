...
//
// 08단원의 마지막 개념 파일입니다.
// 개념02에서 import 를 배우고, 개념03에서 컴포넌트를 파일로 나눴습니다.
...
// 01단원부터 지금까지 .demo · .output 같은 클래스를 그냥 써 왔습니다.
// 어디에도 <style> 을 쓴 적이 없는데 모양이 나왔습니다. 그 정체가 이것입니다.
//
...
// 01단원부터 쭉 쓰던 그 이름들입니다.
//
// 그런데 이 파일(개념04)은 index.css 를 import 하지 않았습니다.
...
//     import "./index.css";
//
// main.jsx 는 앱이 켜질 때 딱 한 번 도는 파일입니다(01단원 개념02).
...
//   하나 만들어 붙입니다. HTML 에 손으로 <style> 을 넣는 것과 같은 일을
//   Vite 가 대신 해 주는 것입니다.
...
//   (개념03에서 부품 .jsx 는 _부품 폴더에 넣어야 했던 것과 다릅니다)
//
...
// ✏️ 직접 해보기 2 — 개념04_CSS_넣기.css 의 .c05Price 색을 #2d6cdf 에서
...
// ✏️ 직접 해보기 7 — 개념04_CSS_넣기.module.css 에 .soldOut 규칙을 추가하고
...
//   className="c05Card" 라고 잘 써 놓고 import "./개념04_CSS_넣기.css"; 를 안 쓴 경우입니다.
...
// import styles from "./개념04_CSS_넣기.css";
...
export default function Concept04Css() {
  ...
  return (
    <div>
      ...
      <p className="guide">
        ...
        <code>개념04_CSS_넣기.css</code>, <code>개념05_다른팀.css</code>,
        <code>개념04_CSS_넣기.module.css</code> 세 개입니다. 함께 열어 놓고 보세요.
        <br />
        <br />
      ...
      <Summary
        items={[
          "실습프로젝트의 src/index.css 는 main.jsx 가 한 번 import 해 두어서 모든 예제에 이미 걸려 있습니다. 01단원부터 써 온 .demo · .output 이 전부 여기 한 곳에 있습니다.",
...
//      }
//
//    → 네 줄입니다. index.css 에 있는 다른 클래스들과 똑같은 모양입니다.
//      다른 점은 이 네 줄이 이 예제에서만 산다는 것입니다.
//
