...
// ------------------------------------------------------------
// 09단원과 13단원 종합03·04는 인터넷에 있는 연습용 서버
// (jsonplaceholder.typicode.com) 에서 데이터를 받아 옵니다.
//
// 학교나 회사 네트워크가 이 주소를 막아 두면 그 예제들이 전부 멈춥니다.
// 그럴 때 이 파일을 켜면 인터넷 없이도 똑같이 동작합니다.
//
//   켜는 법 : 실습프로젝트 폴더의 index.html 을 열고 아래 줄을 찾아
//             앞의 <!-- 와 뒤의 --> 만 지웁니다.
//
//               <!-- <script src="/오프라인_대체.js"></script> -->
//
//             지운 뒤 저장하면 브라우저가 알아서 새로고침됩니다.
//
//   끄는 법 : <!-- 와 --> 를 다시 붙입니다.
//
