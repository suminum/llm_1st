// ============================================================
// 예제 고르기 화면 — 08~14단원의 예제를 왼쪽 목록에서 골라 봅니다
// ------------------------------------------------------------
// 이 파일도 자료가 미리 만들어 둔 '틀'입니다. 고치지 않아도 됩니다.
//
// 여러분이 할 일은 단원 폴더(src/09_... 같은)의 파일을 열어서 읽고 고치는 것입니다.
...
// (14단원 부록은 .tsx 라서 둘 다 봅니다)
const modules = import.meta.glob("./[0-9][0-9]_*/*.{jsx,tsx}");

// "./09_useEffect와_API/개념01_useEffect_기본.jsx"
//   → { unit: "09_useEffect와_API", title: "개념01 useEffect 기본" }
function parse(path) {
